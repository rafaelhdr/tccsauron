...
A camada intermapas passa, então, a ser o ponto de entrada ao módulo de navegação, pois é responsável por gerenciar a navegação intramapa, utilizando as técnicas descritas cima. O algoritmo \ref{algo:intermapas} ilustra seu funcionamento. executa o algoritmo abaixo. Nele, a referência \textbf{pathPlanner} indica o algoritmo de navegação intramapa.
