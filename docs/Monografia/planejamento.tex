...
A arquitetura do módulo de navegação está representada na figura \ref{navegacao:arquitetura}, e possui os submódulos de planejamento intermapas, planejamento de rota e execução.
...
O objetivo do módulo de navegação é guiar o SAURON até destinos escolhidos por um usuário, dentro de um conjunto de mapas previamente informados. Além disso, o módulo deve trabalhar de modo a otimizar o resultado do módulo de localização, essencial ao bom funcionamento do sistema.

Esses mapas sao marcados com alguns pontos, formando um grafo e permitindo a utilização de algoritmos de busca em grafos para planejamento de rota.
