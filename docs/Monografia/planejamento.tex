...
\begin{figure}[h]%
\begin{center}
\includegraphics[width=.7\columnwidth]{imagens/arquiteturaNavegacao.pdf}
...
\begin{figure}[htbp]%
\begin{center}
\includegraphics[width=.8\columnwidth]{imagens/navegacao.jpg}
\caption{O funcionamento do módulo de navegação. As setas vermelhas representam o caminho entre \textit{waypoints}.}%
