...
Para determinação da rota entre mapas utilizou-se um simples algoritmo de Busca em Profundidade aplicado no grafo da relação entre os mapas. Um último ponto que deve ser ressaltado é que, ao realizar a troca de mapas, a postura do robô deve ser atualizada para o sistema de coordenadas do novo mapa.