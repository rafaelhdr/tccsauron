...
Os próximos passos do Modelo de Dinâmica consistem em encontrar as equações da incerteza e implementá-las. Como nos demais modelos são realizados testes para se encontrar as constantes a serem usadas.
