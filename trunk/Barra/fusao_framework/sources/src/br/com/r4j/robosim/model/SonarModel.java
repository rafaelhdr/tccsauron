 ...
 * 1 - O sonar certo ter produzido uma leitura.
 * 2 - Movimento pode ser considerado retil�neo.
 * 
 * 
 * Operação
 * 
...
// PredictedEstimateConsumer, 
{
	...
	// indica se a observa��o est� dentro do alcance do sonar.
...
//	/// Interface DoubleVectorFunction
	...
	/**
	 * 2 - Verifica se uma parede est� sendo rastreada.
	 * 3 - Se n�o, procura uma para rastrear.
	 * 4 - Se sim, verifica se a mesma est� sendo rastreada ainda.
	 * 5 - Se for a mesma, marca como sucesso, e zera contador de falhas.
	 * 6 - Se n�o, marca como insucesso e incrementa contador de falhas.
	 * 7 - Se contador de falhas etiver zerado e mais de uma associa��o com sucesso tiver sido feita, ent�o libera observa��o.
	 * 8 - Se contador de falhas estiver em 3, ent�o resseta tudo, limpando o buffer de parede associada.
	 */
...
//	/// M�todo internos
	...
	/**
	 *  1- Faz update quando uma nova observa��o vai ser tratada.
	 */
	protected boolean prepareForNewObservation(AbstractDoubleVector vectReadings, AbstractDoubleSquareMatrix sensorCovariance, AbstractDoubleVector statePredicted, AbstractDoubleSquareMatrix stateCovar)
	{
		...
		{
			// Determina se deve ou n�o coletar mais pontos, e se j� tem o suficiente.
	...
	/**
	 * 2 - Verifica se com a �ltima medi��o � poss�vel gerar algum resultado.
	 */
	protected boolean validateDate()
	{
		...
		// Testa para ver se o robo n�o rodou.
		// Precisa levar em conta a dist�ncia percorrida (ou n�o?).
...
//		if (rotDist*rotDist > sigma2Rot*rotRejectionValue2)
		...
		// Verifica se a leitura � de alguma coisa
		if (sns.isOutOfRange(arrayReadings[currentIdx]))
			return false;
		
		// Verifica se tem um n�mero m�nimo de leituras v�lidas
		if (logModel.isDebugEnabled())
		...
		// Se tem um n�mero m�nimo de leituras, verifica se elas podem corresponder a 
		// uma parede.
...
//			int diffSmall = diff - cutCount;
			...
			// Se aprovado no segundo teste, n�o valida o teste, mas n�o limpa a refer�ncia associada.
	...
	/**
	 * 3. Associa��o. Associa uma parede�s observa��es.
	 * Retorna falso caso a associa��on�o ocorra ou as �ltimas observa��es 
	 * n�o observam a parede.
	 */
	private boolean processProduceResults(AbstractDoubleVector state, double sigmaX2, double sigmaY2, double sigmaTheta2, int idxParticle)
	{
		...
		// Verifica se uma parede j� assciada continua sendo observada.
	...
	/**
	 *
	 * 1 - Prucura todas a paredes com inclina��o dentro da zona de busca de inclina��es.
	 * 2 - Seleciona as paredes que possuem dist�ncia a x dentro da faixa de erro.
	 * 3 - seleciona a parede com centor de massa mais pr�ximo do sonar.
	 *
	 * @param double xR
	 * @param double yR
	 * @param double thetaR
	...
	private Wall findWall(int idxParticle, double sigmaReading2, double sigmaPosition2, boolean bJustCheck)
	{
		...
		if (!bJustCheck)
		{
			// Primeiro filtro: pela inclina��o da parede e pela posi��o do rob� na �ltmia posi��o
			// (se est� na frente ou atras da parede).
			...
			while (itWalls.hasNext())
			{
				...
				// Segundo filtro: Se a primeira e �ltima observa��es intersectam a parede.
				...
				{			
					...
					// Terceiro filtro: Se a primeira, penultima e �ltima observa��es correspondem a parede.
