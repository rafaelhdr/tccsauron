...
path planning and not localization.   This is provided as an example 
to build on for developing your own localization techniques, as the 
path planning and following will become very innacurate without correction
